...
<head>
    ...
    <script>
        window.AppData = @json(new Billing\Support\AppData)
    </script>
    <script src="https://js.stripe.com/v3/"></script>

    {{ vite_tags('vendor/billing', 5204, 'main.ts') }}

    {{-- {!! new Billing\Support\ViteMobile('127.0.0.1', 5204) !!} --}}

    <script src="https://cdn.usefathom.com/script.js" data-site="OPHHSCEL" data-spa="history" defer></script>
</head>
