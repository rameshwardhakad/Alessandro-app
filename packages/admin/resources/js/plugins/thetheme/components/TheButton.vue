...
<script setup lang="ts">
  ...
  let classes =
    ...
    whiteClass =
      ' text-gray-700 border-gray-300 bg-white enabled:hover:bg-gray-50 focus:ring-indigo-500',
    dangerClass =
      ' text-white border-transparent bg-red-600 enabled:hover:bg-red-700 focus:ring-red-500',
    defaultClass =
      ' text-white border-transparent bg-blue-600 enabled:hover:bg-blue-700 focus:ring-blue-500',
