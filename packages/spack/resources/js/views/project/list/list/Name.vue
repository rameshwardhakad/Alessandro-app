<template>
  <h2
    ref="heading"
    class="flex-1 rounded-lg py-1.5 text-sm font-semibold text-gray-700 focus:bg-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-600 ltr:pl-2 ltr:pr-2 rtl:pl-2 rtl:pr-2"
    :class="{
