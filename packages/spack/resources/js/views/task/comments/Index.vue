<template>
  <section class="mt-8">
    <Collapsible name="task-comments" :open="true">
      <template #trigger="{ open }">
        <div class="flex">
          ...
          <div class="flex-1 border-b pb-2">
            <span class="text-sm font-medium text-gray-800">{{ __('Comments') }} </span>
      ...
      <template #content>
        <div class="pt-4 ltr:pl-8 rtl:pr-8">
          <CommentForm />
          <CommentItems />
        </div>
      </template>
...
<script setup lang="ts">
  ...
  import CommentForm from './form/Index.vue'
  import CommentItems from './items/Index.vue'
