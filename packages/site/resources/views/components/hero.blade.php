                ...
                <nav class="relative flex items-center justify-between sm:h-10 md:justify-center" aria-label="Global">
                    <div class="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                        <div class="flex items-center justify-between w-full md:w-auto">
                            @if (option('front_site_logo'))
                                <a href="/" class="flex items-center">
                                    <img class="h-8 w-auto sm:h-10" src="/{{ option('front_site_logo') }}" alt="">
                                </a>
                            @else
                                <a href="/" class="flex items-center">
                                    <img class="h-8 w-auto sm:h-10" src="/img/site-logo.svg" alt="">
                                    <span class="text-gray-800 ml-2 font-semibold text-[1.625rem]">
                                        {{ config('app.name') }}
                                    </span>
                                </a>
                            @endif
        ...
        <main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
            <div class="text-center">
                <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                    <span class="block xl:inline">{{ option('front_site_heading') }}</span>
                    <!-- <span class="block text-indigo-600 xl:inline">online business</span> -->
                </h1>
                <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                    {{ option('front_site_short_description') }}
                </p>
